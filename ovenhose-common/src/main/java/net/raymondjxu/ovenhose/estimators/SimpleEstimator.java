 ...
 */
package net.raymondjxu.ovenhose.estimators;

import net.raymondjxu.ovenhose.BoilerpipeExtractor;
import net.raymondjxu.ovenhose.document.TextDocumentStatistics;
import net.raymondjxu.ovenhose.extractors.ArticleExtractor;
import net.raymondjxu.ovenhose.extractors.DefaultExtractor;
