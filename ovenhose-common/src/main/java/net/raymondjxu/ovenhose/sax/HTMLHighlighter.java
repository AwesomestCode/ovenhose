...
import net.raymondjxu.ovenhose.org.cyberneko.html.HTMLConfiguration;
...
public final class HTMLHighlighter {
  ...
  private String extraStyleSheet = "\n<style type=\"text/css\">\n" + ".x-ovenhose-mark1 {"
      ...
      "</style>\n";
  private String preHighlight = "<span class=\"x-ovenhose-mark1\">";
   ...
   * "x-ovenhose-mark1" as inline text with yellow background.
   */
   ...
   * 
   * By default, this corresponds to <code>&lt;span class=&qupt;x-ovenhose-mark1&quot;&gt;</code>
   */
  ...
  private final class Implementation extends AbstractSAXParser implements ContentHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes atts)
      ...
      if ("SPAN".equalsIgnoreCase(localName)) {
        ...
        if ("x-ovenhose-mark1".equals(classVal)) {
          ignoreAttrs = true;
        }
      }
