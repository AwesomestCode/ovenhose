...
import net.raymondjxu.ovenhose.labels.LabelAction;
...
public abstract class CommonTagActions {
   ...
   * 
   * There is a bug in certain versions of NekoHTML which still allows nested tags. If ovenhose
  ...
  public static final TagAction TA_ANCHOR_TEXT = new TagAction() {
    ...
    public boolean start(BoilerpipeHTMLContentHandler instance, final String localName,
      ...
      if (instance.inAnchor++ > 0) {
        ...
        // parser
        System.err
            .println("Warning: SAX input contains nested A elements -- You have probably hit a bug in your HTML parser (e.g., NekoHTML bug #2909310). Please clean the HTML externally and feed it to ovenhose again. Trying to recover somehow...");
